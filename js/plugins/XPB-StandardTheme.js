/*: 
 * @plugindesc XPStyleBattle for MV Theme - Standard Theme Ver. 0.1.0
 ...
 * @min 0
 * @max 2
 * @desc アクターの水平方向の整列0: 左 1: 中央 2: 右 [Default: 1]
 * 
 * @param (integer)general.verticalAlignment
 * @type number
 * @min 0
 * @max 2
 * @desc アクターの垂直方向の整列0: 上 1: 中央 2: 下 [Default: 0]
 * 
 ...
 * @min -4096
 * @max 4096
 * @desc 名前の X 座標 [Default: 12]
 * 
 * @param (integer)name.y
 * @type number
 * @min -4096
 * @max 4096
 * @desc 名前の Y 座標 [Default: 9]
 * 
 ...
 * @type string
 * @desc 名前の縁取り色 [Default: rgba(0,0,0,0.5)]
 * 
