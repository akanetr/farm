 ...
 * @author Sasuke KANNAZUKI, Yoji Ojima, Triacontan
 * 
 * @default 
 * @param bgBitmapMenu
 ...
 * 
 * @param isDisplayTp
 * @desc when display actors' status, whether to display TP or not. (1 = yes, 0 = no)
 * @default 0
 * 
 ...
 * @author 神無月サスケ, Yoji Ojima, トリアコンタン
 * 
 * @param bgBitmapMenu
 ...
 * 
 * @param isDisplayTp
 * @desc ステータス表示の際に、TPを表示するかを選択します。(1 = する, 0 = しない)
 * @default 0
 * 
...
(function() {
    ...
    var isDisplayTp = !!Number(parameters['isDisplayTp']);
   ...
   //
    ...
    Window_MenuStatus.prototype.drawItemStatus = function(index) {
        ...
        if (isDisplayTp) {
            ...
            this.drawActorIcons(actor, x, bottom - lineHeight * 5, width);
        } else {
