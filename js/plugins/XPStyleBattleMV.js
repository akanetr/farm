/*:
 * @plugindesc XPStyleBattle for MV Build200211
...
(function () {
    ...
    Window_Options.prototype.changeValue = function (symbol, value) {
        ...
        if (this.isCustomSymbol && this.isCustomSymbol(symbol) && !isNaN(value)) {
            ...
            if ("BD.CMD.xpbBattleSpeed" === script) {
            ...
            (function (BattleObjects) {
                ...
                (function (Components) {
                    ...
                    var XPStyleBattler = (function (_super) {
                        ...
                        XPStyleBattler.prototype.updateFutureSight = function () {
                        };
...
(function () {
    ...
    var _bdc_Game_Actor_onBattleStart = Game_Actor.prototype.onBattleStart;
    Game_Actor.prototype.onBattleStart = function () {
        _bdc_Game_Actor_onBattleStart.apply(this, arguments);
    ...
    Game_Actor.prototype.isBigEnemy = function () {
        return false;
    };
})();
...
(function () {
    ...
    Spriteset_Battle.prototype.createHUDSprite = function () {
        if (Scene_Battle.prototype.createHudField !== undefined &&
            Scene_Battle.prototype.createHudField !== mogActorPictureCM) {
            Scene_Battle.prototype.createHudField = mogActorPictureCM;
        }
...
(function () {
    ...
    BattleManager.startInput = function () {
        ...
        this.doStartInputCallback();
    };
    BattleManager.doStartInputCallback = function () {
...
(function () {
    ...
    Window_PartyCommand.prototype.activate = function () {
        ...
        if (typeof Imported !== "undefined" && Imported["SceneFormation"]) {
            BattleManager.doStartInputCallback();
        }
    };
})();
